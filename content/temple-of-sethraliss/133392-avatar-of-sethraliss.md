...
- [Essence Defiler](#/d/temple-of-sethraliss/map/mob/268427) — **Defiling Taint** channels into the
  Avatar and *prevents all external healing*. Two of them, 4.3 million health each.
- [Corrupted Guardian](#/d/temple-of-sethraliss/map/mob/268344) — a 485k tank buster, a charge, and
  **Unstable Corruption**, which erupts for 485k within 20 yards and forms Corrupted Lifeforce.
- [Lifeforce](#/d/temple-of-sethraliss/map/mob/268364) — the orbs. Touching one cleanses it;
...
- [Twisted Hexxer](#/d/temple-of-sethraliss/map/mob/268491) and
  [Faithless Tormentor](#/d/temple-of-sethraliss/map/mob/268729) — encounter versions of the trash,
