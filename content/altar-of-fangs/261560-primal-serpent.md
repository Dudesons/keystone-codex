...
MDT's tooltip records the debuff's size and duration but not that it stacks. That part is
observed in game, and it is the reason this mob is rated where it is.
