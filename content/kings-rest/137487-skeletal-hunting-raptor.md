...
One unit at 10 forces, and the [Honored Raptor](#/d/kings-rest/codex/mob/135192)'s leap with an
enrage bolted on.

**Bestial Berserk** is the difference: 25% more speed on everything nearby, for 15 seconds.
It is the same spell [Queen Patlaa](#/d/kings-rest/codex/mob/137486) casts, and the tooltip still
